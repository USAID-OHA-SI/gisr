...
assess_facilities <- function(.data) {
    ...
    p <- .data %>%
        ...
        ggplot2::geom_hline(yintercept = 0, color = glitr::grey20k) +
        ggplot2::geom_hline(yintercept = 25, color = glitr::grey20k) +
        ggplot2::geom_hline(yintercept = 50, color = glitr::grey20k) +
        ggplot2::geom_hline(yintercept = 75, color = glitr::grey20k) +
        ggplot2::geom_hline(yintercept = 100, color = glitr::grey20k) +
        ggplot2::geom_col(aes(y = t), fill = glitr::grey10k) +
