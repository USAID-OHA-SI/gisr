...
Below is an example. This assumes your R / Github projects folder is under `Documents` folder on your local computer and you are working off a R Project in a sub-folder. In this example, your geospatial data folder will be a sibling of your R / Github projects folder.

```{r echo = T, eval = F}
curr_path <- "C:/Users/<username>/Documents/geodata/vector" # Windows
#or 
#curr_path <- "~/Documents/Documents/geodata/vector"        # Mac or linux
...
spdf_pepfar <- get_vcpolygons(folderpath = si_path(type = "path_vector")) 
...
Extract country boundaries from VcPepfarPolygons and GHSD/DATIM orgunits
...
Extract PSNU boundaries from VcPepfarPolygons and GHSD/DATIM orgunits
...
df_attrs <- grabr::get_attributes(country = cntry,
                                  username = datim_user(),
                                  password = datim_pwd())

spdf_all <- cntry_polygons(spdf = spdf_pepfar, cntry = cntry, attrs = df_attrs)
