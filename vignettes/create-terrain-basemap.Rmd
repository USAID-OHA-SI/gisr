...
For this, We will need to download the [raster file](https://www.naturalearthdata.com/downloads/50m-raster-data/50m-shaded-relief/) into `si_path("path_raster")`

This option uses `rnaturalearth` to extract admin0 and admin1 boundaries as `sf` objects.

```{r warning=FALSE, echo = T, eval = F}

dir_ras <- file.path("..", glamr::si_path("path_raster"))

ras <- get_raster(folderpath = dir_ras, name = "SR_LR.tif")
